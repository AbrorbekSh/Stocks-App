...
//
//[ "AAPL", "AMZN", "MSFT", "GOOGL", "BRK.B", "META",
//  "UNH", "JNJ", "JPM", "V", "PG","XOM","HD", "CVX","MA",
//  "BAC","ABBV", "PFE", "AVGO","COST", "DIS", "KO",
//  "ABEV", "F", "CCL", "NIO","CERN", "AAL", "NVDA", "SOFI", "T",
...
struct StocksManager {
    ...
    func fetchUrl() -> [CellObject]{
        let tickers = [ "AAPL", "AMZN", "MSFT", "GOOGL", "META"
                        ,
                        "UNH", "JNJ", "JPM", "V", "PG","XOM","HD", "CVX",
                        "ABBV", "PFE", "AVGO","COST", "DIS", "KO",
                        "ABEV", "F", "CCL", "NIO","CERN", "AAL", "NVDA", "SOFI", "T",
                        "BABA", "NOK",  "PBR", "SNAP", "PLTR", "TSLA", "COIN"
                      ]
